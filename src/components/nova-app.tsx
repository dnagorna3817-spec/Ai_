...
function Sidebar({ path }: { path: string }) {
  ...
  return <aside className="sidebar">
    ...
    <div className="profile"><span>Д</span><div><b>Діана</b><small>Адміністратор</small></div></div>
  </aside>;
}
...
function Dashboard() {
  ...
  const activities = [
    ...
    { time: "10:01", actor: "Клієнтська комунікація", text: "Підготувала запит документів. Очікує рішення Діани.", kind: "AI ACTION" },
    ...(approved ? [
      { time: "10:04", actor: "Діана", text: "Погодила запит клієнту.", kind: "HUMAN ACTION" },
  ...
  return <Shell path="/office"><div className="page office-page">
    <header className="page-head office-head"><div><p className="eyebrow">ЧЕТВЕР, 4 ВЕРЕСНЯ</p><h1>Доброго ранку, Діано.</h1><p>Ваша AI-команда працює.</p></div><div className="summary"><span><b>3</b> працівники працюють</span><i /><span><b>12</b> активних завдань</span><i /><span><b>{approved ? 0 : 1}</b> {approved ? "рішень на погодженні" : "рішення очікує на вас"}</span></div></header>
